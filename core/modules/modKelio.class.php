 ...
 */
class modKelio extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->description = "Description of module Kelio";
		...
		$this->config_page_url = array("kelio_setup.php@kelio");
		...
		$this->langfiles = array("kelio@kelio");
        ...
        // Dictionaries
	    if (! isset($conf->kelio->enabled))
        {
        	$conf->kelio=new stdClass();
        	$conf->kelio->enabled=0;
        }
	...
	function init($options='')
	{
		...
		dol_include_once('/kelio/config.php');
		dol_include_once('/kelio/script/create-maj-base.php');

		$result=$this->_load_tables('/kelio/sql/');
